  ...
  Future<void> _saveTask() async {
    ...
    try {
      if (widget.task == null) {
        ...
        if (_reminderDateTime != null && !_completed) {
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          _reminderDateTime == null
                              ...
                              : '${_reminderDateTime!.day.toString().padLeft(2, '0')}/${_reminderDateTime!.month.toString().padLeft(2, '0')}/${_reminderDateTime!.year} às ${_reminderDateTime!.hour.toString().padLeft(2, '0')}:${_reminderDateTime!.minute.toString().padLeft(2, '0')}',
                        ),
                        trailing: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
